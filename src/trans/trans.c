...
void trans(void)
{
    ...
    if(POWER == 25){
        ...
        tr[i].m = (MCORE) {.D = 7.65, .Mu = 10000., .B = 1.85, .Lc = 1., .Sfc = 0.95, .R = 60, .Rp[0] = 80, .Rp[1] = 1 };
        tr[i].i[0] = (INS) {.D = 3.26, .T = 1.};
    ...
    if(trans_optim(&(tr[i]), LOST, p, 3)) { printf("No any result!!!\n"); return; }
