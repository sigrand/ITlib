...
*/
void find_object(uint32 *ing, uint16 *out, uint32 *hist, const int w, const int h, const int br, const int th, Object *obj)
{
    int i, j=0, x, y, yw, yw1, yx, yx1, w1 = w + br*2, cn;
    ...
    memset(hist, 0, sizeof(uint32)*2048);
...
>>>>>>> a221427749e28cbfb1f88ded06b51fddd7ab9578
    }
